/* =========================================================================================
   ...
   Base de Datos: das_fabrica_burger
   ========================================================================================= */
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'provincias')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'localidades')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'zonas')
CREATE TABLE zonas (
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'tipos_comidas')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'especialidades_alimentarias')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'estilos')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'categorias_precios')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'restaurantes')
...
CREATE TABLE sucursales (
    ...
    min_tolerencia_reserva  INT          NOT NULL DEFAULT 0,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'zonas_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'turnos_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'zonas_turnos_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'contenidos')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'clicks_contenidos')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'tipos_comidas_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'especialidades_alimentarias_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'estilos_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'reservas_sucursales')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_localidades_prov_nom')
CREATE INDEX IX_localidades_prov_nom
    ON localidades (cod_provincia, nom_localidad);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_sucursales_localidad')
CREATE INDEX IX_sucursales_localidad
    ON sucursales (nro_localidad);
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_turnos_sucursales_busq')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_reservas_busqueda')
...
PRINT 'Tablas creadas/verificadas exitosamente en das_fabrica_burger';
GO
